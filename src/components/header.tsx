...
const Header = () => {
  ...
  return  <header className=" sticky top-0 w-full z-50 border-b bg-background/95 backdrop-blur py-2 supports-[backdrop-filter]:bg-background/60"> 
    <div className="container mx-auto flex h-16  items-center justify-between px-4"> 
        <Link to={"/"}>
        <img src={isDark? "/logo (1).png" : "/logo2.png"} alt="Klimate Logo" className="h-14"/>
